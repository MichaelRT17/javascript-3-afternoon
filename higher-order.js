...
//Code Here
let totalPopulation  = populations.reduce((firstVal,num) => firstVal + num)
...
let bobsTotal = purchases.filter(element => element.owner === "Bob").map(element => element.price).reduce((runningTotal, num) => runningTotal + num)
